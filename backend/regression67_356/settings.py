"""
Django settings for regression67_356 project.
...
ROOT_URLCONF = 'regression67_356.urls'
...
WSGI_APPLICATION = 'regression67_356.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "regression67_356 API",
    "DESCRIPTION": "API documentation for regression67_356 App",
    "VERSION": "v1",
}
